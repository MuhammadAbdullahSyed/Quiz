...
if (Question2 === `let myVar: string = 'Hello'`) marks += 10
if (Question3 === `To define the structure of objects`) marks += 10
if (Question4 === "const") marks += 10
...
let myAns = () => {
    ...
    else {`unfortunately your marks are ${marks}`}
    }
myAns()
